        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
              Ton espace d&apos;entraide academique a l&apos;
            ...
            <p className="text-lg md:text-xl text-primary-100 mb-8 max-w-xl mx-auto lg:mx-0">
              ...
              tes documents. Rejoins la communaute etudiante Yatalko et reussis
              ensemble.
            </p>
          ...
          <div className="hidden lg:block">
            <div className="relative">
              {/* Floating Cards */}
              <div className="absolute -top-4 -left-4 bg-white rounded-xl shadow-xl p-4 transform -rotate-6 animate-float">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-xs">Verifie</p>
                  </div>
                </div>
              </div>

              <div className="absolute top-1/2 -right-8 bg-white rounded-xl shadow-xl p-4 transform rotate-6 animate-float-delayed">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500 text-xs">Reponse acceptee</p>
                  </div>
                </div>
              </div>
                ...
                <div className="aspect-square max-w-md mx-auto flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-white/80 text-lg">
                      Illustration etudiants collaborant
                    </p>
                  </div>
                </div>
              </div>
